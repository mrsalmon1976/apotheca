  ...
  <div class="page-layout">
    ...
    <div class="main-body">
      ...
      <div v-else-if="tasks.length === 0" class="empty-state">
        ...
        <p class="empty-state-message">There are no tasks open for you across any projects. Have a great day!</p>
      </div>
...
watch(activeFilter, filter => loadTasks(filter), { immediate: true })
</script>
