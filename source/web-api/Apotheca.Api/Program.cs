...
using Apotheca.Api.Features.Users.GetUserTasks;
using Apotheca.Api.Features.Labels.SearchLabels;
using Apotheca.Api.Features.Search;
using Apotheca.Api.Features.Mindmaps.CreateMindmap;
using Apotheca.Api.Features.Mindmaps.DeleteMindmap;
using Apotheca.Api.Features.Mindmaps.GetMindmap;
using Apotheca.Api.Features.Mindmaps.GetMindmaps;
using Apotheca.Api.Features.Mindmaps.CreateMindmapNode;
using Apotheca.Api.Features.Mindmaps.SaveMindmapNode;
using Apotheca.Api.Features.Mindmaps.DeleteMindmapNode;
using Apotheca.Api.Features.Mindmaps.SaveMindmap;
...
builder.Services.AddTransient<CreateProjectRepository>();
builder.Services.AddTransient<CreateProjectValidator>();
builder.Services.AddTransient<GetProjectUsersRepository>();
builder.Services.AddTransient<AddProjectUserRepository>();
builder.Services.AddTransient<AddProjectUserValidator>();
builder.Services.AddTransient<SaveProjectUserRoleRepository>();
builder.Services.AddTransient<SaveProjectUserRoleValidator>();
builder.Services.AddTransient<RemoveProjectUserRepository>();
builder.Services.AddTransient<CreateWorkspaceRepository>();
builder.Services.AddTransient<CreateWorkspaceValidator>();
builder.Services.AddTransient<GetUserWorkspacesRepository>();
builder.Services.AddTransient<SaveWorkspaceRepository>();
builder.Services.AddTransient<SaveWorkspaceValidator>();
builder.Services.AddTransient<GetWorkspaceUsersRepository>();
builder.Services.AddTransient<AddWorkspaceUserRepository>();
builder.Services.AddTransient<AddWorkspaceUserValidator>();
builder.Services.AddTransient<SaveWorkspaceUserRoleRepository>();
builder.Services.AddTransient<SaveWorkspaceUserRoleValidator>();
builder.Services.AddTransient<RemoveWorkspaceUserRepository>();
builder.Services.AddTransient<SwitchCurrentWorkspaceRepository>();
...
builder.Services.AddTransient<GetProjectNotesRepository>();
...
builder.Services.AddTransient<RenameNoteFolderRepository>();
builder.Services.AddTransient<RenameNoteFolderValidator>();
builder.Services.AddTransient<MoveNoteRepository>();
...
builder.Services.AddTransient<RenameDocumentFolderRepository>();
builder.Services.AddTransient<RenameDocumentFolderValidator>();
builder.Services.AddTransient<MoveDocumentRepository>();
...
builder.Services.AddTransient<CreateMindmapRepository>();
builder.Services.AddTransient<CreateMindmapValidator>();
builder.Services.AddTransient<DeleteMindmapRepository>();
builder.Services.AddTransient<GetMindmapRepository>();
builder.Services.AddTransient<GetMindmapsRepository>();
builder.Services.AddTransient<SaveMindmapRepository>();
builder.Services.AddTransient<SaveMindmapValidator>();
builder.Services.AddTransient<CreateMindmapNodeRepository>();
builder.Services.AddTransient<SaveMindmapNodeRepository>();
builder.Services.AddTransient<SaveMindmapNodeValidator>();
builder.Services.AddTransient<DeleteMindmapNodeRepository>();
